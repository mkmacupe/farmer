...
public class DataInitializer implements CommandLineRunner {
  ...
  private static final int DEMO_PRODUCT_TARGET_COUNT = 250;
  ...
  private static final Map<String, CatalogDescriptor> CATALOG_PRODUCT_BY_BASENAME = Map.ofEntries(
      ...
      Map.entry("acacia-honey", new CatalogDescriptor("Мёд акациевый 500 г", "Пчеловодство")),
      Map.entry("apple-carrot-juice", new CatalogDescriptor("Сок яблочно-морковный 1 л", "Напитки")),
      Map.entry("beef-cutlets", new CatalogDescriptor("Котлеты говяжьи 700 г", "Полуфабрикаты")),
      Map.entry("black-beans", new CatalogDescriptor("Фасоль чёрная 800 г", "Бобовые")),
      Map.entry("black-cumin-oil", new CatalogDescriptor("Масло чёрного тмина 250 мл", "Масла")),
      Map.entry("blackcurrant-drink", new CatalogDescriptor("Морс черносмородиновый 1 л", "Напитки")),
      Map.entry("bulgur", new CatalogDescriptor("Булгур золотистый 900 г", "Крупы и бобовые")),
      Map.entry("celery-leaf", new CatalogDescriptor("Сельдерей листовой 100 г", "Зелень")),
      Map.entry("cherry-compote", new CatalogDescriptor("Компот вишнёвый 1 л", "Напитки")),
      Map.entry("chestnut-honey", new CatalogDescriptor("Мёд каштановый 500 г", "Пчеловодство")),
      Map.entry("chicken-cutlets", new CatalogDescriptor("Котлеты куриные 700 г", "Полуфабрикаты")),
      Map.entry("chickpeas-premium", new CatalogDescriptor("Нут калиброванный 800 г", "Бобовые")),
      Map.entry("cilantro-fresh", new CatalogDescriptor("Кинза свежая 100 г", "Зелень")),
      Map.entry("couscous", new CatalogDescriptor("Кускус пшеничный 700 г", "Крупы и бобовые")),
      Map.entry("dill-fresh", new CatalogDescriptor("Укроп свежий 100 г", "Зелень")),
      Map.entry("golubtsy", new CatalogDescriptor("Голубцы домашние 900 г", "Полуфабрикаты")),
      Map.entry("grape-seed-oil", new CatalogDescriptor("Масло виноградной косточки 500 мл", "Масла")),
      Map.entry("green-peas-dry", new CatalogDescriptor("Горох зелёный сушёный 800 г", "Бобовые")),
      Map.entry("hemp-oil", new CatalogDescriptor("Масло конопляное 250 мл", "Масла")),
      Map.entry("kvass-bread", new CatalogDescriptor("Квас хлебный 1 л", "Напитки")),
      Map.entry("lecho", new CatalogDescriptor("Лечо домашнее 700 г", "Консервация")),
      Map.entry("lima-beans", new CatalogDescriptor("Фасоль лима 800 г", "Бобовые")),
      Map.entry("manti-beef", new CatalogDescriptor("Манты фермерские 900 г", "Полуфабрикаты")),
      Map.entry("meatballs", new CatalogDescriptor("Фрикадельки мясные 700 г", "Полуфабрикаты")),
      Map.entry("mineral-water-still", new CatalogDescriptor("Вода минеральная негазированная 1 л", "Напитки")),
      Map.entry("mung-beans", new CatalogDescriptor("Маш зелёный 800 г", "Бобовые")),
      Map.entry("oat-flakes", new CatalogDescriptor("Овсяные хлопья 800 г", "Крупы и бобовые")),
      Map.entry("parsley-fresh", new CatalogDescriptor("Петрушка свежая 100 г", "Зелень")),
      Map.entry("pearl-barley", new CatalogDescriptor("Перловка отборная 900 г", "Крупы и бобовые")),
      Map.entry("pickled-beet", new CatalogDescriptor("Свёкла маринованная 500 г", "Консервация")),
      Map.entry("pickled-cucumbers", new CatalogDescriptor("Огурцы маринованные 900 г", "Консервация")),
      Map.entry("pickled-tomatoes", new CatalogDescriptor("Томаты маринованные 900 г", "Консервация")),
      Map.entry("pickled-vegetable-mix", new CatalogDescriptor("Ассорти овощное маринованное 900 г", "Консервация")),
      Map.entry("pinto-beans", new CatalogDescriptor("Фасоль пинто 800 г", "Бобовые")),
      Map.entry("pumpkin-seed-oil", new CatalogDescriptor("Масло тыквенное 250 мл", "Масла")),
      Map.entry("quinoa-white", new CatalogDescriptor("Киноа белая 700 г", "Крупы и бобовые")),
      Map.entry("red-lentils", new CatalogDescriptor("Чечевица красная 800 г", "Бобовые")),
      Map.entry("rocket-salad", new CatalogDescriptor("Руккола свежая 125 г", "Зелень")),
      Map.entry("sea-buckthorn-oil", new CatalogDescriptor("Масло облепиховое 250 мл", "Масла")),
      Map.entry("sea-buckthorn-syrup", new CatalogDescriptor("Сироп облепиховый 500 мл", "Напитки")),
      Map.entry("sesame-oil", new CatalogDescriptor("Масло кунжутное 250 мл", "Масла")),
      Map.entry("sorrel-fresh", new CatalogDescriptor("Щавель свежий 150 г", "Зелень")),
      Map.entry("soup-beans-mix", new CatalogDescriptor("Смесь бобовая суповая 800 г", "Крупы и бобовые")),
      Map.entry("spinach-young", new CatalogDescriptor("Шпинат молодой 125 г", "Зелень")),
      Map.entry("sunflower-oil-unrefined", new CatalogDescriptor("Масло подсолнечное нерафинированное 1 л", "Масла")),
      Map.entry("tomato-juice", new CatalogDescriptor("Сок томатный 1 л", "Напитки")),
      Map.entry("vareniki-curd", new CatalogDescriptor("Вареники с творогом 800 г", "Полуфабрикаты")),
      Map.entry("vareniki-potato", new CatalogDescriptor("Вареники с картофелем 800 г", "Полуфабрикаты")),
      Map.entry("walnut-oil", new CatalogDescriptor("Масло грецкого ореха 250 мл", "Масла")),
      Map.entry("zucchini-caviar", new CatalogDescriptor("Икра кабачковая 500 г", "Консервация")),
